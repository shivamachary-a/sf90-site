        ...
        <VStack>
          <Box textAlign="center" fontSize="xl" position="relative" display="flex" justifyContent="left" alignItems="left" p="10vw" h="100vh" w="100vw">
            ...
            <HStack>
              ...
              <img style={{ height: "auto", width: "15vw", position: "relative" }} alt="" src="https://media.discordapp.net/attachments/692861972731002995/852534965886910484/Simulator_Screen_Shot_-_iPhone_12_Pro_Max_-_2021-06-10_at_14.07.59.png?width=578&height=1251"></img>
              <img style={{ height: "auto", width: "15vw", position: "relative", left: "-5vw" }} alt="" src="https://media.discordapp.net/attachments/692861972731002995/852534963898548304/Simulator_Screen_Shot_-_iPhone_12_Pro_Max_-_2021-06-10_at_14.07.56.png?width=578&height=1251"></img>
              <VStack>
      ...
      <ChakraProvider theme={theme}>
        <VStack>
          <Box textAlign="center" fontSize="xl" position="relative" display="flex" justifyContent="left" alignItems="left" p="10vw" h="100vh" w="100vw">
            ...
            <VStack>
              <img style={{ height: "auto", width: "100vw", position: "relative" }} alt="" src="https://media.discordapp.net/attachments/692861972731002995/852534963898548304/Simulator_Screen_Shot_-_iPhone_12_Pro_Max_-_2021-06-10_at_14.07.56.png?width=578&height=1251"></img>
              <VStack>
                <Heading>meet SF90</Heading>
                <Text>the first complete financial ecosystem built from the ground up with a focus on sustainability, ethics, and community.</Text>
                <Heading>coming soon.</Heading>
